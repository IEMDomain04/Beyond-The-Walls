...
export default function Navbar() {
    ...
    return (
        <nav className="top-0 flex justify-between items-center py-4 bg-orange-50 px-6 md:px-10">
            {/* Logo Section */}
            <div className="flex items-center space-x-3 cursor-pointer">
                <img src="https://cdn-icons-png.flaticon.com/128/698/698684.png" width={50} height={50} alt="Logo" />
            ...
            <div className="md:hidden">
                <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="p-2 rounded bg-orange-200">
                    <svg
            ...
            {/* Dropdown Menu */}
            {isMenuOpen && (
                <div className="absolute top-16 left-0 m-2 w-full bg-orange-50 flex flex-col items-center space-y-4 py-4 shadow-md md:hidden">
